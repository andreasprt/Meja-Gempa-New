...
{
  static_assert(sizeof...(steppers) < MaxMotors, "motor terlalu banyak, naikkan nilai MaxMotors di file MotorControlBase.h");
...
{
  static_assert(N <= MaxMotors, "motor terlalu banyak, naikkan nilai MaxMotors di file MotorControlBase.h");
